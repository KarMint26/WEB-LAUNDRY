...
<body>
    <div class="wrapper d-flex align-items-stretch">
        ...
        <!-- ... (Your existing code for the sidebar and page content) ... -->
        ...
        <div id="content" class="p-4 p-md-5">
            ...
            <form action="./proses_edit.php" method="POST" onsubmit="event.preventDefault(); submitForm();" >
                <input type="text" name="id_customer" id="id_customer" hidden value="<?= $customer['id_customer'] ?>">
                <div class="mb-3 mt-3">
    ...
    <script>
		async function submitForm() {
			...
			await fetch('./proses_edit.php', {
					...
					body: 'id_customer=' + encodeURIComponent(id_customer) + '&nama=' + encodeURIComponent(nama) + '&tgl_lahir=' + encodeURIComponent(tgl_lahir) +
						'&alamat=' +
